    ...
    <Container className='flex'>
        ...
        <div className='content flex'>
          ...
          <div className='text flex'>
            <p>
              Nosso principal objetivo é oferecer soluções integradas e personalizadas para atender às necessidades específicas de cada cliente. Com um trabalho colaborativo e multidisciplinar, envolvendo profissionais especializados.
            </p>
            <p>
